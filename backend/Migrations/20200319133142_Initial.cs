        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FollowerId = table.Column<Guid>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClanFollow", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ClanFollow_AspNetUsers_FollowerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CrAccounts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CrAccounts_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClanFollow_FollowerId",
                table: "ClanFollow",
                column: "FollowerId");

            migrationBuilder.CreateIndex(
                name: "IX_CrAccounts_UserId",
                table: "CrAccounts",
                column: "UserId");
